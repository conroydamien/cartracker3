...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "cartracker3@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "cartracker3 API";

        private String description = "cartracker3 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "cartracker3";
